      ...
      <GridContainer justify="center">
        <GridItem xs={12} sm={12} md={12}>
          ...
          <h5 className={classes.description} style={justify}>
            ...
            electronically at <a> ijdam.editor@gmail.com</a> . After the final acceptance of the
            ...
            once submitted for consideration in IJDAM, cannot be withdrawn unless the same is
            finally rejected.
          </h5>
        </GridItem>
      </GridContainer>
      ...
      <GridContainer justify="center">
        <GridItem xs={12} sm={12} md={12}>
          ...
          <h5 className={classes.description}>
            ...
            corrections and return them to IJDAM in an e-mail
            <a> editor@dam-journal.com </a>. Please list corrections quoting line number. If, for
            ...
            responsibility. Note that IJDAM will proceed with the publication of paper, if no

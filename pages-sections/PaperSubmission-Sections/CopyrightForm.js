      ...
      <GridContainer justify="center">
        <GridItem xs={12} sm={12} md={12}>
          ...
          <h5 className={classes.description} style={justify}>
            Copyright of all accepted papers will belong to IJDAM and the author(s) must affirm that
            accepted papers for publication in IJDAM must not be re-published elsewhere without the
            written consent of the editor-in-chief of IJDAM. To comply with this policy, authors

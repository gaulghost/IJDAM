      ...
      <GridContainer justify="center">
        <GridItem xs={12} sm={12} md={12}>
          ...
          <h5 className={classes.description} style={justify}>
            Reviewers play a central role in scholarly publishing. IJDAM uses double-blind peer
            ...
            <br />
            <br />
            <b>IJDAM</b> is committed to prompt evaluation and publication of fully accepted papers.
          ...
          <List>
            ...
            <ListItem>
              ...
              <ListItemText
                className={classes.description}
                primary="
                  All manuscripts submitted for publication in IJDAM cross-checked for plagiarism software. Manuscripts found to be plagiarized during initial stages of review are out-rightly rejected and not considered for publication in the journal."
              />
            </ListItem>
            <ListItem>
              <ListItemIcon>

      ...
      <GridContainer justify="center">
        <GridItem xs={12} sm={12} md={11}>
          ...
          <h5 className={classes.description} style={justify}>
            Data Analytics and Management Journal (IJDAM) is an annual international
            scientific peer-reviewed journal. Journal publishes original scientific papers,
            preliminary communications, Big Data, Computational Intelligence and Communication
            Networks. Publication in Innovative Computing and Communication Journal is without
            any costs/charge to authors. All processing and publishing costs are borne by the
            journal owner rather than by the author.
            <br />
            Data Analytics and Management Journal is dedicated to the dissemination of
      ...
      <div>
        ...
        <GridContainer justify="center">
          <GridItem xs={12} sm={12} md={11}>
            ...
            <h5 className={classes.description} style={justify}>
              The Data Analytics and Management Journal - IJDAM will not accept or publish
        ...
        <GridContainer justify="center">
          <GridItem xs={12} sm={12} md={11}>
            ...
            <h5 className={classes.description} style={justify}>
              Publication in Data Analytics and Management Journal (IJDAM) is without any
